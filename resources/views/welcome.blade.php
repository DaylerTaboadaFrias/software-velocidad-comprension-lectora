...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body  class="antialiased">
        <div style="background: #D9D9D9;" class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
            ...
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img class="p-6 object-fill h-30 w-40 dark:shadow-gray-800" src="{{ asset('logoEvenPher2.png') }}" alt="image description" style="width: auto !important;
                ...
                <div class="p-2 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l ">
                    ...
                    <div class="flex flex-row-reverse space-x-4 space-x-reverse ">
                        ...
                        <div class="p-4 mr-2 w-full max-w-sm bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <a href="{{ url("/process-payment",$plan) }}" type="button" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choose plan</a>
                        </div>
                        @endforeach
                    </div>
